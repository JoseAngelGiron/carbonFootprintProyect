...
public class DeletePrintController extends Controller implements Initializable {
    ...
    List<Huella> prints;
    ObservableList<Huella> observablePrints;
    ...
    public void deletePrint(){
        ...
        if(printSelected!=null){
            HuellaServices service = new HuellaServices();
            service.delete(printSelected.getId());
        }
    }
        ...
        printTable.setOnMouseClicked(event -> {
            if (event.getClickCount() == 2) {
                ...
                if (printSelected != null) {
                    ...
                    LocalDate date = printSelected.getFecha();
